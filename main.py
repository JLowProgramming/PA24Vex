...
while True:
    left_motor.set_velocity((controller_1.axis4.position() + controller_1.axis3.position()), 50)
    right_motor.set_velocity((controller_1.axis4.position() - controller_1.axis3.position()), 50)
